...
namespace Telerik.Windows.Controls.QuickStart.Common.Helpers
{
    public class ApplicationThemeManager
    {
        ...
        private static readonly string[] allThemes = new string[]
        {
            ...
            ApplicationThemeManager.VisualStudio2013DefaultThemeName,
            ApplicationThemeManager.VisualStudio2013DarkThemeName,
            ApplicationThemeManager.VisualStudio2013BlueThemeName,
#if WPF
            ApplicationThemeManager.GreenLightThemeName,
            ApplicationThemeManager.GreenDarkThemeName
#endif
        };
