...
#pragma warning restore 0618
            ...
            private Uri GetTransparentThemeImageUri()
            {
                ...
                #else
                return new Uri(string.Format("/Telerik.Windows.QuickStartUITheme;component/Images/bg0{0}.jpg", random.Next(1, 7)), UriKind.RelativeOrAbsolute);
                #endif
            }
