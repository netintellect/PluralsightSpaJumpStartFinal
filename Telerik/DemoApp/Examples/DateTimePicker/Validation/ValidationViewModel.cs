...
namespace Telerik.Windows.Examples.DateTimePicker.Validation
{
	public class ValidationViewModel : ViewModelBase, IDataErrorInfo
	{
		public ValidationViewModel()
		{
			...
			this._ReturnDateChanged = false;
			this._Reserve = new DelegateCommand(this.ReserveAction);
			this._DisplayDateStart = new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1);
			this._DisplayDateEnd = (new DateTime(DateTime.Now.Year, DateTime.Now.Month, 1)).AddMonths(3).AddDays(-1);
		}
