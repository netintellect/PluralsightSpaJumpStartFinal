...
#else
            // The Dispatcher fixes an SL automation peer issue on touch devices.
            Dispatcher.BeginInvoke(() => this.UndoRedo(sender as System.Windows.Controls.ListBox, isUndo));
#endif
        }
