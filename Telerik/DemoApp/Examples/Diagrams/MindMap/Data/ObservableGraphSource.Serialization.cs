	...
	public partial class ObservableGraphSource : ISerializableGraphSource
	{
		...
		public object DeserializeNode(IShape shape, SerializationInfo info)
		{
			...
			if (info["ShapeType"] != null)
				newNode.ShapeType = (MindmapItemType)Enum.Parse(typeof(MindmapItemType), info["ShapeType"].ToString(), true);
			...
			{
				string[] indexes = info["SelectedIconsIndexes"].ToString().Split(";".ToCharArray(), StringSplitOptions.RemoveEmptyEntries);
