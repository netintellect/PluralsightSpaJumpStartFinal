...
{
    public class WorkDaysGenerator : ITimeRangeGenerator
    {
        public System.Collections.Generic.IEnumerable<IPeriodSpan> GetRanges(Controls.SelectionRange<DateTime> visibleRange)
        {
            TimeSpan slotSpan = TimeSpan.FromDays(5);
            var differenceFirstVisible = DayOfWeek.Monday - visibleRange.Start.DayOfWeek;
