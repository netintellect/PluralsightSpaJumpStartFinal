...
namespace Telerik.Windows.Examples.PivotGrid.Export
{
    ...
    {
        private ZipCompression compression;
        ...
        public Example()
        {
            ...
            {
                new ExportType { ImageSource = new Uri("/PivotGrid;component/Icons/ExcelIcon.png", UriKind.RelativeOrAbsolute), ExportFormat = "Excel" },
                new ExportType { ImageSource = new Uri("/PivotGrid;component/Icons/WordIcon.png", UriKind.RelativeOrAbsolute), ExportFormat = "Word" },
                new ExportType { ImageSource = new Uri("/PivotGrid;component/Icons/PdfIcon.png", UriKind.RelativeOrAbsolute), ExportFormat = "PDF" },
                new ExportType { ImageSource = new Uri("/PivotGrid;component/Icons/HtmlIcon.png", UriKind.RelativeOrAbsolute), ExportFormat = "HTML" },
            };
