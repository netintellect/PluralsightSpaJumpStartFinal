...
namespace Telerik.Windows.Examples
{
    public abstract class DataSourceViewModelBase : ViewModelBase
    {
        ...
        protected const string wpfPath = "/Chart;component/DataSources/{0}";
...
#else
            Uri dataURI = new Uri(Telerik.Windows.Examples.Chart.URIHelper.CurrentApplicationURL, string.Format(DataSourceViewModelBase.silverlightPath, fileName));
