...
namespace Telerik.Windows.Examples
{
    public abstract class DataSourceViewModelBase : ViewModelBase
    {
        ...
        protected const string wpfPath = "/Treemap;component/DataSources/{0}";
...
#else
            Uri dataURI = new Uri(URIHelper.CurrentApplicationURL, string.Format(DataSourceViewModelBase.silverlightPath, fileName));
