...
namespace Telerik.Windows.Examples.Map.Stadium
{
    ...
    {
#if SILVERLIGHT
        private const string ShapeRelativeUriFormat = "DataSources/Geospatial/Stadium/{0}";
        private const string StadiumViewImageUriFormat = "/Examples/Map/Stadium/Images/{0}";
#else
        private const string ShapeRelativeUriFormat = "/Map;component/Resources/Stadium/{0}";
        private const string StadiumViewImageUriFormat = "/Map;component/Stadium/Images/{0}";
#endif
